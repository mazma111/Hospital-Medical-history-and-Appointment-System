...
def create_doctor_gui():
  ...
  root = tk.Tk()
  root.title("Admin Page - Medical Management System")
  ...
  welcome_label = tk.Label(left_frame, text="Welcome Mr.Ahmed",fg="#4682b4", font=("Arial", 20, "bold"))
  ...
  img = Image.open("C:/Users/dd/OneDrive/Desktop/programming/python/gui/hospital.jpeg")
  
  new_img = img.resize((400, 590))

    # حفظ الصورة المعدلة (اختياري)

  new_img.save("C:/Users/dd/OneDrive/Desktop/programming/python/gui/hospital.jpeg")
