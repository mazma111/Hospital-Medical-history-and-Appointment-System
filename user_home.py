...
def create_doctor_gui():
  ...
  root = tk.Tk()
  root.title("user Page - Medical Management System")
  ...
  welcome_label = tk.Label(left_frame, text="Welcome in our system",fg="#4682b4", font=("Arial", 20, "bold"))
  #welcome_label.pack(pady=20)
  welcome_label.place(x=50, y=250)
  ...
  img = Image.open("C:/Users/dd/OneDrive/Desktop/programming/python/gui/patiant.jpg")
  
  new_img = img.resize((400, 590))

  new_img.save("C:/Users/dd/OneDrive/Desktop/programming/python/gui/patiant.jpg")
